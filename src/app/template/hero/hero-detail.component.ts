...
export class HeroDetailComponent {
  hero = new HeroTemplate(-1, '', 'Zzzzzzzz'); // default sleeping hero
  ...
  deleteRequest = new EventEmitter<HeroTemplate>();
...
export class BigHeroDetailComponent extends HeroDetailComponent {
  @Input() override hero!: HeroTemplate;
  @Output() override deleteRequest = new EventEmitter<HeroTemplate>();
